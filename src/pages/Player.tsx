...
import { getJawshanSection, getTotalSections } from '@/data/jawshan';
import { QuranContent, InvocationsContent, AdhanContent, PlayerControls, JawshanContent } from '@/components/player';
