    ...
    <div className="fixed inset-0 bg-background flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12">
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-2xl">
        ...
        <div className="flex items-center gap-2 sm:gap-4 mb-4 sm:mb-8">
          ...
          <span className="text-2xl sm:text-3xl lg:text-4xl text-primary animate-pulse">☪</span>
          <div className="h-px w-16 sm:w-24 lg:w-32 bg-gradient-to-l from-transparent to-primary/60" />
        </div>

        {/* Prayer name */}
        <h1 className="font-arabic text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-primary text-shadow-gold mb-2 sm:mb-4 animate-gentle-pulse">
          {prayer.arabicName}
        </h1>
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-light tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-4 sm:mb-8">
          {prayer.name}
        </h2>
        ...
        <div className="flex gap-3 sm:gap-6">
          <button
            ...
            className="p-3 sm:p-4 glass-card hover:bg-card/80 focus:ring-2 focus:ring-primary rounded-full transition-all"
          >
            {isMuted ? (
          ...
          <button
            ...
            className="flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 glass-card hover:bg-card/80 focus:ring-2 focus:ring-primary rounded-full transition-all"
          >
